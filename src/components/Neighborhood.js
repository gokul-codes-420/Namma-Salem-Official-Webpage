    ...
    <Section id="location">
      ...
      <Container>
        ...
        <MosaicGrid>
          ...
          >
            <img
              src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/05/cc/b6/00/sivaraj-holiday-inn.jpg?w=1200&h=-1&s=1"
              alt="Dining"
            />
            <OverlayInfo
              initial={{ y: 20 }}
          ...
          >
            <img
              src="https://cf.bstatic.com/xdata/images/hotel/max500/358171804.jpg?k=1bf391c7289fe188d816273762dea8258f94eadb2461e8cfbf090fe9a5decdce&o="
              alt="Shopping"
            />
            <OverlayInfo
              initial={{ y: 20 }}
            ...
            >
              <GoldTag>
                <FiShoppingBag /> Salem Official Hub
              </GoldTag>
              <h3
                style={{
                  color: "#dbd9d9ff",
          ...
          >
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGyXj6FXeHiNmzdzNzAYoSehWn1PcX_9ELDY0PzVE4il-swiCtu0DVpWw&s=10"
              alt="Culture"
            />
            <OverlayInfo
              initial={{ y: 20 }}
