...
export default function Hero() {
  return (
    <HeroSection id="home">
      ...
      <GlassContainer>
        <LocationBadge>
          <FiMapPin /> Namma Salem , Mettur , Tamilnadu
        </LocationBadge>

        <Title>
          Salem Travel Guide
          <span>Best Time to Visit Salem</span>
        </Title>

        <Subtitle>
          Salem is One of the most notable tourist attractions in Salem happens to be Yercaud followed by the Mettur Dam.
        </Subtitle>
